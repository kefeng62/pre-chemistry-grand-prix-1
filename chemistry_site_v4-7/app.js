const exams = {
  1: {
    name: '問題1（基礎化学）',
    answers: [2,2,1,3,4,0,5,4,5,3,0,8,4,1,2,8,0,9,9,5,1,0,0,3,7,1,1,2,2,3,1,1,1,1,0,4,3,2,4,9,3],
    labels: [
  ...
  4: {
    name: '問題4（物理化学）',
    answers: [3,2,1,1,5,8,3,1,3,5,1,5,9,3,1,5,0,1,7,5,5,6,8,1,0,1,3,2,1,2,3,1,2,9,8,1,5,5,5],
    labels: [
